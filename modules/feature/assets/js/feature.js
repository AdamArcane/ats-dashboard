(function ($) {
	$(document)
		.on("ats_dashboard_jquery_init", function () {
			var nonce = $(".ats-features-page").find("#ats_module_nonce");

			/** @type {JQuery<HTMLInputElement>} */
			const checkboxes = $(".ats-features-page").find(
			...
			function sendBatchSave() {
				...
				var data = {
					action: "ats_handle_module_actions",
					nonce: nonce.val(),
		...
		.trigger("ats_dashboard_jquery_init");
})(jQuery);
