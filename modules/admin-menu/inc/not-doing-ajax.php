 ...
 * - it is executed earlier than ats, and they do similar stuff like Yoast SEO
 ...
 */
function ats_admin_menu_not_doing_ajax() {
	...
	$allowed_actions = array( 'ats_admin_menu_get_menu', 'ats_admin_menu_search_urls', 'ats_admin_menu_quick_update_visibility' );
	 ...
	 *
	 * @see wp-content/plugins/ats-dashboard/modules/ats-core-admin-menu/ajax/class-get-menu.php
	 */
