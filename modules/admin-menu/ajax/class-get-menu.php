...
class Get_Menu {
	...
	public function ajax() {
		 ...
		 *
		 * @see wp-content/plugins/ats-dashboard/modules/ats-core-admin-menu/class-admin-menu-output.php
	 ...
	 * The `get_admin_menu` in that file it self is hooked into `ats_ajax_get_admin_menu`action
	 ...
	 *
	 * @see wp-content/plugins/ats-dashboard/modules/ats-core-admin-menu/inc/not-doing-ajax.php
	 */
	public function load_menu() {
		 ...
		 *
		 * The value of `wp_doing_ajax` was set to `false` in ats-dashboard/ats-dashboard.php file
		 * by calling `ats_admin_menu_not_doing_ajax` function.
		 *
		 * @see wp-content/plugins/ats-dashboard/modules/ats-core-admin-menu/inc/not-doing-ajax.php
		 */
		add_filter( 'wp_doing_ajax', '__return_true' );

		$this->recent_menus = get_option( 'ats_recent_admin_menu', array() );
	 ...
	 *
	 * The `ats_recent_admin_menu` is done in the `admin_menu` hook before ats's admin menu output is implemented.
	 ...
	 * If the `ats_admin_menu_show_ui_capabilities` filter returning empty, this function will stop earlier.
	 ...
	 * can also add support for ats admin menu editor.
	 *
	...
	public function check_menu_items_capability() {
		 ...
		 * So other plugin's author / team can add support for ats admin menu editor.
		 */
		$show_ui_capabilities = apply_filters( 'ats_admin_menu_show_ui_capabilities', $show_ui_capabilities );
	...
	/**
	 * Compare default global $menu with saved ats_recent_menu.
	 * If some menu exists in recent menu but not in default menu,
	 * then add it to the default menu.
	 *
	 * The `ats_recent_menu` was set in `save_recent_menu` method
	...
	/**
	 * Compare default global $submenu with saved ats_recent_menu.
