...
class Reset_Menu {
	...
	/**
	 * Reset the menu back to WordPress's native, unmodified menu.
	 *
	 * There's a single saved menu list now, so there's no more "reset this
	 * role" vs "reset everything" distinction - resetting just clears it.
	 */
