...
return function () {
	...
	<div class="atsui-right-footer">
		<button type="button" class="button button-large button-danger ats-menu-builder--button ats-menu-builder--reset-button">
			<?php _e( 'Reset Menu to Default', 'ats-dashboard' ); ?>
		</button>
	</div>
