...
return function () {
	...
	<div class="atsui-right-footer">
		...
		<button type="button" class="button button-large button-danger ats-menu-builder--button ats-menu-builder--reset-button ats-menu-builder--reset-role" data-role="default">
			<?php _e( 'Reset Default Menu', 'ats-dashboard' ); ?>
		</button>
	</div>
