...
$wp_customize->add_control(
	new Customize_Range_Control(
		...
		array(
			'type'        => 'range',
			'section'     => 'ats_login_customizer_button_section',
			'settings'    => 'ats_login[button_height]',
...
$wp_customize->add_control(
	new Customize_Range_Control(
		...
		array(
			'type'        => 'range',
			'section'     => 'ats_login_customizer_button_section',
			'settings'    => 'ats_login[button_horizontal_padding]',
...
$wp_customize->add_control(
	new Customize_Range_Control(
		...
		array(
			'type'        => 'range',
			'section'     => 'ats_login_customizer_button_section',
			'settings'    => 'ats_login[button_border_radius]',
...
$wp_customize->add_control(
	new Customize_Color_Control(
		...
		array(
			...
			'section'  => 'ats_login_customizer_button_section',
			'settings' => 'ats_login[button_text_color]',
		)
	)
);
...
$wp_customize->add_control(
	new Customize_Color_Control(
		...
		'ats_login[button_text_color_hover]',
		array(
			'label'    => __( 'Text Color (Hover)', 'ats-dashboard' ),
			'section'  => 'ats_login_customizer_button_section',
			'settings' => 'ats_login[button_text_color_hover]',
		)
	)
);
...
$wp_customize->add_control(
	new Customize_Color_Control(
		...
		array(
			...
			'section'  => 'ats_login_customizer_button_section',
			'settings' => 'ats_login[button_bg_color]',
		)
	)
);
...
$wp_customize->add_control(
	new Customize_Color_Control(
		...
		'ats_login[button_bg_color_hover]',
		array(
			'label'    => __( 'Background Color (Hover)', 'ats-dashboard' ),
			'section'  => 'ats_login_customizer_button_section',
			'settings' => 'ats_login[button_bg_color_hover]',
		)
	)
);
