...
class ats_Customize_Color_Picker_Control extends \WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wp-color-picker-alpha', ATS_DASHBOARD_PLUGIN_URL . '/assets/js/wp-color-picker-alpha.min.js', array( 'wp-color-picker' ), ATS_DASHBOARD_PLUGIN_VERSION, true );
	...
	protected function render() {
		...
		$this->input_attrs['class'] .= ' ats-customize-field ats-customize-' . $this->type . '-field color-picker-hex';
	...
	public function render_content() {
		...
		<header class="ats-customize-control-header">
			<?php if ( ! empty( $this->label ) ) : ?>
				<label for="<?php echo esc_attr( $input_id ); ?>-visual-helper" class="customize-control-title ats-customize-control-label ats-customize-control-title"><?php echo esc_html( $this->label ); ?></label>
			<?php endif; ?>
			<?php if ( ! empty( $this->description ) ) : ?>
				<span id="<?php echo esc_attr( $description_id ); ?>" class="description customize-control-description ats-customize-control-description"><?php echo wp_kses_post( $this->description ); ?></span>
			<?php endif; ?>
			<input
				type="hidden"
		...
		<div class="ats-customize-control-content">
			<input
				type="text"
