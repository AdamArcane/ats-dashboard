 ...
 * Custom range control.
 */
class ats_Customize_Range_Control extends \WP_Customize_Control {
	/**
	 * Control's type.
	 *
	 * @var string
	...
	public function render_content() {
		...
		<header class="ats-customize-control-header">
			...
			<?php endif; ?>
			<span class="dashicons dashicons-image-rotate ats-customize-control-reset" title="<?php esc_attr_e( 'Reset Value', 'ats-dashboard' ); ?>" data-reset-value="<?php echo esc_attr( $this->value() ); ?>"></span>
		</header>
		<div class="ats-customize-control--cols">
			<div class="ats-customize-control--left-col">
				<input
					...
					class="ats-customize-control-range-slider"
