...
class Save_Modules {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_ats_plugin_onboarding_save_modules', [ $this, 'handler' ] );
	...
	private function validate() {
		...
		if ( ! wp_verify_nonce( $nonce, 'ats_plugin_onboarding_save_modules_nonce' ) ) {
	...
	private function save() {
		...
		wp_send_json_success( __( 'Modules saved', 'ats-dashboard' ) );
