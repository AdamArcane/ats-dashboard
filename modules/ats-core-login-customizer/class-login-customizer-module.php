...
class Login_Customizer_Module extends Base_Module {
	...
	public function __construct() {
		...
		$this->url = ATS_DASHBOARD_CORE_URL . '/modules/ats-core-login-customizer';
	...
	public function control_scripts() {
		...
		wp_enqueue_script( 'ats-login-customizer-control', $this->url . '/assets/js/controls.js', array( 'customize-controls' ), ATS_DASHBOARD_PLUGIN_VERSION, true );

		wp_enqueue_script( 'ats-login-customizer-events', $this->url . '/assets/js/preview.js', array( 'customize-controls' ), ATS_DASHBOARD_PLUGIN_VERSION, true );
	...
	public function create_js_object() {
		...
		return array(
			...
			'pluginUrl'    => rtrim( ATS_DASHBOARD_CORE_URL, '/' ),
			'moduleUrl'    => ATS_DASHBOARD_CORE_URL . '/modules/ats-core-login-customizer',
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'ats-login-customizer-preview', $this->url . '/assets/js/preview.js', array( 'customize-preview' ), ATS_DASHBOARD_PLUGIN_VERSION, true );
