...
class ats_Customize_Color_Picker_Control extends \WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wp-color-picker-alpha', ATS_DASHBOARD_CORE_URL . '/assets/js/wp-color-picker-alpha.min.js', array( 'wp-color-picker' ), ATS_DASHBOARD_PLUGIN_VERSION, true );
