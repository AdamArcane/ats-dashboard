...
class ats_Customize_Login_Template_Control extends \WP_Customize_Control {
	...
	public function render_content() {
		...
		$plugin_url = ats_is_pro_active() ? ATS_DASHBOARD_CORE_URL : ATS_DASHBOARD_CORE_URL;

		$login_templates = array(
			'default' => array(
				'thumbnail' => $plugin_url . '/modules/ats-core-login-customizer/assets/images/template-default.jpg',
				'bg_image'  => '',
			),
			'left'    => array(
				'thumbnail' => $plugin_url . '/modules/ats-core-login-customizer/assets/images/template-left.jpg',
				'bg_image'  => '',
			),
			'right'   => array(
				'thumbnail' => $plugin_url . '/modules/ats-core-login-customizer/assets/images/template-right.jpg',
				'bg_image'  => '',
			),
		);
		?>
