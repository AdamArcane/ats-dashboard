...
return function () {
	...
	$login_redirect = get_option( 'ats_login_redirect' );
	$login_slug     = isset( $login_redirect['login_url_slug'] ) ? trim( $login_redirect['login_url_slug'], '/' ) : '';

	$general_settings = array(
		array(
			'name'  => 'remove_help_tab',
			'title' => __( 'Remove Help Tab', 'ats-dashboard' ),
		),
		array(
			'name'  => 'remove_screen_options',
			'title' => __( 'Remove Screen Options Tab', 'ats-dashboard' ),
		),
		array(
			'name'  => 'remove_admin_bar',
			'title' => __( 'Remove Admin Bar from Frontend', 'ats-dashboard' ),
		),
	);
	...
	<div class="wrap heatbox-wrap ats-onboarding-wizard-page">
			...
			<div class="heatbox-container heatbox-container-center">
				...
				<div class="logo-container">
					...
					<div style="width: 80%">
						...
						<p class="subtitle">
							<?php esc_html_e( 'Complete the Setup Wizard and get started with ATS Dashboard in less than a minute.', 'ats-dashboard' ); ?>
						</p>
					</div>
		...
		<div class="heatbox-container heatbox-container-center">
			...
			<div class="heatbox onboarding-wizard-heatbox">
				...
				<div class="ats-onboarding-wizard-slides">
					<div class="ats-onboarding-wizard-slide ats-modules-slide">

						<header>
							<h2>
								<?php esc_html_e( 'Features', 'ats-dashboard' ); ?>
							</h2>

							<p>
								<?php esc_html_e( 'Select the features you\'d like to enable. You can change them later in the "Modules" tab.', 'ats-dashboard' ); ?>
							</p>
						</header>
					...
					<div class="ats-onboarding-wizard-slide ats-widgets-slide">
						...
						<header>
							...
							<p>
								<?php esc_html_e( 'Let\'s clean up your dashboard. Remove some or all of the default WordPress widgets.', 'ats-dashboard' ); ?>
							</p>
						</header>
						...
						<ul class="ats-modules">
							<li>
								<div class="module-text">
									<h3>
										<label for="ats_widgets__remove-all">
											<?php esc_html_e( 'Remove all Dashboard Widgets', 'ats-dashboard' ); ?>
										</label>
									</h3>
								</div>
								<div class="widget-toggle">
									<label for="ats_widgets__remove-all" class="label checkbox-label">
										<input
											type="checkbox"
											name="ats_widgets[remove-all]"
											id="ats_widgets__remove-all"
											value="1"
							...
							<!-- Divider with text -->
							<div class="ats-divider for-widget-remove-all">
								<span class="divider-text"><?php esc_html_e( 'Or remove individual widgets', 'ats-dashboard' ); ?></span>
							</div>
							
							<li>
								<div class="module-text">
									<h3>
										<label for="ats_widgets__welcome_panel">
											<?php esc_html_e( 'Welcome Panel', 'ats-dashboard' ); ?>
										</label>
									</h3>
								</div>
								<div class="widget-toggle">
									<label for="ats_widgets__welcome_panel" class="label checkbox-label">
										<input
											type="checkbox"
											name="ats_widgets[welcome_panel]"
											id="ats_widgets__welcome_panel"
											value="1"
						...
						<?php foreach ( $widgets as $id => $widget ) : ?>
							...
							<li>
								<div class="module-text">
									<h3>
										<label for="ats_widgets__<?php echo esc_attr( $slug ); ?>">
											<?php echo esc_html( $title ); ?>
										</label>
									</h3>
								</div>
								<div class="widget-toggle">
									<label for="ats_widgets__<?php echo esc_attr( $slug ); ?>" class="label checkbox-label">
										<input
											type="checkbox"
											name="ats_widgets[<?php echo esc_attr( $slug ); ?>]"
											id="ats_widgets__<?php echo esc_attr( $slug ); ?>"
											value="1"
											<?php checked( $is_checked, 1 ); ?>
										>
					...
					<div class="ats-onboarding-wizard-slide ats-general-settings-slide">

						<header>
							<h2>
								<?php esc_html_e( 'General Settings', 'ats-dashboard' ); ?>
							</h2>

							<p>
								<?php esc_html_e( 'Next, let\'s simplify the WordPress Dashboard interface by removing extra elements for a cleaner look.', 'ats-dashboard' ); ?>
							</p>
						</header>
								...
								<li class="<?php echo ( 'remove_admin_bar' === $setting['name'] ? 'has-select2' : '' ); ?>">
									...
									<?php if ( 'remove_admin_bar' === $setting['name'] ) : ?>
										...
										<div class="role-dropdown">
											<h3><label for="remove_by_roles" class="dropdown-label"><?php esc_html_e( 'Hide Admin Bar for:', 'ats-dashboard' ); ?></label></h3>
											<select name="remove_by_roles[]" id="remove_by_roles" class="full-width-dropdown use-select2" multiple data-placeholder="<?php esc_attr_e( 'Select Role', 'ats-dashboard' ); ?>">
									...
									<?php else : ?>
										...
										<div class="module-text">
											<h3>
												<label for="ats_settings__<?php echo esc_attr( $slug ); ?>">
													<?php echo esc_html( $title ); ?>
												</label>
											</h3>
										</div>
										...
										<div class="setting-toggle">
											<label for="ats_settings__<?php echo esc_attr( $slug ); ?>" class="label checkbox-label">
												<input
													type="checkbox"
													name="ats_settings[<?php echo esc_attr( $slug ); ?>]"
													id="ats_settings__<?php echo esc_attr( $slug ); ?>"
													value="1"
													<?php checked( $is_checked, 1 ); ?>
												>
												<div class="indicator"></div>
					...
					<div class="ats-onboarding-wizard-slide ats-custom-login-url-slide">
						<header>
							<h2>
								<?php esc_html_e( 'Custom Login URL', 'ats-dashboard' ); ?>
							</h2>
							<p>
								<?php esc_html_e( 'Customize the login URL to enhance security and avoid common login page attacks.', 'ats-dashboard' ); ?>
							</p>
						</header>

						<div class="ats-subscription-form">
							<!-- URL Row -->
							<div class="ats-form-row onboarding-wizard-login-url">
								<code class="onboarding-wizard-login-url"><?php esc_html_e( 'yourdomain.com', 'ats-dashboard' ); ?>/</code>
								<input
									type="text" 
									name="ats_login_redirect[login_url_slug]" 
									id="ats_login_redirect" 
									class="ats-input onboarding-wizard-login-url"
							...
							<div class="ats-discount-notif"></div>
							...
							<div class="ats-form-row">
								...
								echo wp_kses_post( sprintf( __( 'This will replace your login URL (<code>%1$s/wp-login.php</code>) and help secure your site by making the login page less predictable.', 'ats-dashboard' ), esc_url( site_url() ) ) );
								?>
							</p>
							</div>
						</div>
					...
					<div class="ats-onboarding-wizard-slide ats-subscription-slide">
						...
						<header>
							...
							<p>
								<?php echo wp_kses_post( __( 'Unlock all features! Subscribe to our newsletter and claim your <strong>exclusive discount</strong> on ATS Dashboard.', 'ats-dashboard' ) ); ?>
							</p>
						</header>
						...
						<div class="ats-subscription-form">
							...
							<div class="ats-form-row ats-onboarding-wizard-skip-discount">
								<a href="">
					...
					<div class="ats-onboarding-wizard-slide ats-finished-slide">
				...
				<footer class="heatbox-footer">
					...
					<div class="heatbox-footer-item">
						<button type="button" class="button button-large button-primary ats-button save-button">
							<?php esc_html_e( 'Next', 'ats-dashboard' ); ?>
						</button>
					</div>
				</footer>

				<div class="ats-discount-notif for-discount is-hidden">
					<?php echo wp_kses_post( __( 'Don\'t miss out.<br> <strong>This discount won\'t come back!</strong>', 'ats-dashboard' ) ); ?>
				</div>
			...
			<div class="heatbox-footer skip-onboarding-wizard">
				<div class="heatbox-footer-item">
					<a href="#" id="skip-setup-onboarding-wizard" class="skip-onboarding-wizard-link">
						<?php esc_html_e( 'Skip Setup Wizard', 'ats-dashboard' ); ?>
					</a>
				</div>
			</div>
			...
			<div class="heatbox-footer onboarding-wizard-explore-settings">
				<div class="heatbox-footer-item">
					<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=ats_widgets&page=ats_settings' ) ); ?>" id="onboarding-wizard-explore-settings" class="onboarding-wizard-explore-settings-link is-hidden">
						<?php esc_html_e( 'Explore Settings', 'ats-dashboard' ); ?>
					</a>
				</div>
			</div>
