...
namespace ats\OnboardingWizard;
...
class Onboarding_Wizard_Module extends Base_Module {
	...
	public function __construct() {
		...
		$this->url = ATS_DASHBOARD_CORE_URL . '/modules/onboarding-wizard';
	...
	public function submenu_page() {
		...
		add_submenu_page(
			...
			__( 'Setup Wizard', 'ats-dashboard' ),
			__( 'Setup Wizard', 'ats-dashboard' ),
			apply_filters( 'ats_modules_capability', 'manage_options' ),
			'ats_onboarding_wizard',
