...
class Login_Redirect_Output extends Base_Output {
	...
	public function setup_hooks() {
		...
		$this->new_login_slug = apply_filters( 'ats_login_slug', $this->new_login_slug );

		$this->wp_admin_redirect_slug = isset( $settings['wp_admin_redirect_slug'] ) ? $settings['wp_admin_redirect_slug'] : '';
		$this->wp_admin_redirect_slug = apply_filters( 'ats_wp_admin_redirect_slug', $this->wp_admin_redirect_slug );
