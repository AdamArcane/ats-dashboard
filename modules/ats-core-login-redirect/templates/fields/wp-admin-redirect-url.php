...
return function () {
	...
	<div class="ats-url-prefix-suffix-field">
		...
		<input type="text" name="ats_login_redirect[wp_admin_redirect_slug]" class="all-options" value="<?php echo esc_attr( $slug ); ?>" placeholder="404" />
	...
	<p class="description">
		...
		echo wp_kses_post( sprintf( __( 'Redirect non-logged-in users that try to access <code>%1$s/wp-admin/</code>.', 'ats-dashboard' ), esc_url( site_url() ) ) );
		?>
	</p>
